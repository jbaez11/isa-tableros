          ...
          <template>
            ...
            <tbody>
              ...
              >
                ...
                <td style="text-align: center;">
                  {{ scoresbykeywords.results["actitud comercial"].toFixed(1) }}
                  %
                </td>
                <td style="text-align: center;">
                  {{
                    scoresbykeywords.results["gestión del contacto"].toFixed(1)
                  }}
                  %
                </td>
                <td style="text-align: center;">
    ...
    filteredCalls: function() {
      ...
      return this.recordScoreByKeywords
        ...
        .sort((a, b) => {
          ...
          if (filtrarPor1 == 2) {
            if (
              parseFloat(a.results["gestión del contacto"]) >
              parseFloat(b.results["gestión del contacto"])
            ) {
              return this.sortOrderCalls;
            }
          }
          if (filtrarPor1 == 3) {
            if (
              parseFloat(a.results["transparencia"]) >
              parseFloat(b.results["transparencia"])
            ) {
              return this.sortOrderCalls;
            }
          }
